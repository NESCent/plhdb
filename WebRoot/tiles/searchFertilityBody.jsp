...
<li><a href="/report/fertility_<c:out value='${year}' />_12_31.csv.go">12/31/<c:out value="${year}" /></a>
</li></c:if>
<c:if test="${current_month>7 && yea>2010}">
<li><a href="/report/fertility_<c:out value='${year}' />_7_31.csv.go">7/31/<c:out value="${year}" /></a>
</li></c:if>
</ul>
