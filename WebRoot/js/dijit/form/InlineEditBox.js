	...
	//		It must also be able to initialize with style="display:none;" set.
{
	...
	startup: function(){
	    ...
	    if(!this._started){
		    ...
		    //add hidden input to record values
		   /*
		    var hideInput=document.createElement("input");
		    hideInput.setAttribute("name",this.editWidget.domNode.getAttribute("id"));
		    hideInput.setAttribute("value",this.editWidget.getValue());
		    hideInput.setAttribute("type","hidden");
		    this.containerNode.appendChild(hideInput);	
		    this.hiddenInput=hideInput;
		    */
	...
	save: function(e){
		...
		//this.hiddenInput.value=this._lastValue;
