...
public class StringUtils {
	...
	public static String join(List<String> list, String delim) {
		StringBuffer sb = join(list.toArray(new String[0]), delim,
				new StringBuffer());
		return sb.toString();
	}

	/**
	 * Concatenates all the elements in the given array, using the given
	 * delimiter.
	 */
	...
	/**
	 * Concatenates all the elements in the given array, using the given
	 * delimiter. The result is appended to the given string buffer, which is
	 * therefore modified in place.
	 */
